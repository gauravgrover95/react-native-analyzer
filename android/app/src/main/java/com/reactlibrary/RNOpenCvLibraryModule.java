...
public class RNOpenCvLibraryModule extends ReactContextBaseJavaModule {
    ...
    // @ReactMethod
    // public void bark(Callback errorCallback, Callback successCallback) {
    //     // String test = Util.speak();
    //     successCallback.invoke(test);
    // }
    ...
    // @ReactMethod
    // public void dummy(Callback errorCallback, Callback successCallback) {
    //     System.out.println("is blur image");
    //     successCallback.invoke("Hello from native opencv module");
    // }
